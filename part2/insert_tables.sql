...
values ("jose@gmail.com", "himynameisjose", "Jose Bolanos", 6, "Metrotech", "Brooklyn", "New York", 1234567, 111111, '2024-12-20', "Guatemala", '2000-09-21');

insert into customer (email, password, name, adrr_building_num, adrr_street, addr_city, addr_state, phone_num, passport_num, passport_exp, passport_country, date_of_birth) 
values ("jaeha@gmail.com", "himynameisjaeha", "Jaeha Huh", 6, "Metrotech", "Brooklyn", "New York", 128723947, 112344, '2024-04-12', "United States", '2000-04-15');    

insert into customer (email, password, name, adrr_building_num, adrr_street, addr_city, addr_state, phone_num, passport_num, passport_exp, passport_country, date_of_birth) 
values ("mat@gmail.com", "himynameismat", "Mat Brown", 6, "Metrotech", "Brooklyn", "New York", 29759472, 1287398, '2023-11-16', "United States", '1999-12-30');
...
values ("john@gmail.com", "youcantseeme", "John", "Cena");
